...
import org.firstinspires.ftc.teamcode.opmodes.test.TestTeleopBase;

@TeleOp(name="Teleop Test", group="driver control")
@Disabled
public class TestTeleop extends TestTeleopBase {
...
//
    @Override
    public void on_init() {
//        robot.led_control.update_pattern(LEDConst.DEFAULT);
    }
//
    @Override
